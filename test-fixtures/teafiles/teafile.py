...
class TeaFile:
    ...
    @staticmethod
    def create(filename, fieldnames, itemname=None, fieldformat=None, contentdescription=None, namevalues=None):
        '''
        ...
        id_ = ItemDescription.create(itemname, fieldnames, fieldformat)
